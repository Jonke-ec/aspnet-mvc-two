...
namespace WebApp.Controllers
{
    public class ProfileEntitiesController : Controller
    {
        ...
        public ProfileEntitiesController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Address,PostalCode,City,UserId")] ProfileEntity profileEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address,PostalCode,City,UserId")] ProfileEntity profileEntity)
        {
